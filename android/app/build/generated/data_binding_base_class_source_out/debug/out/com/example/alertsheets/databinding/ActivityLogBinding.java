...
public final class ActivityLogBinding implements ViewBinding {
  ...
  private ActivityLogBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView recyclerLogs) {
  ...
  public static ActivityLogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLogBinding((LinearLayout) rootView, recyclerLogs);
    }
